...
var _Authenticate = require('./components/authentication/Authenticate.vue');

var _Authenticate2 = _interopRequireDefault(_Authenticate);

var _FeedbackButton = require('./components/buttons/FeedbackButton.vue');
...
_vue2.default.http.options.root = appGlobals.urlProtocol + appGlobals.rootAppPath;
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = appGlobals.csrf;

// Use Animate.css Transitions - https://daneden.github.io/animate.css/
_vue2.default.transition('bounce-down-up', {
    enterClass: 'bounceInDown',
    leaveClass: 'bounceOutUp'
});
_vue2.default.transition('slide-down', {
    enterClass: 'slideInDown',
    leaveClass: 'slideOutDown'
});
_vue2.default.transition('slide-up', {
...
var VAccordion = _vue2.default.extend(VueStrap.accordion);
var VAffix = _vue2.default.extend(VueStrap.affix);
var VAlert = _vue2.default.extend(VueStrap.alert);
var VAside = _vue2.default.extend(VueStrap.aside);
var VCarousel = _vue2.default.extend(VueStrap.carousel);
var VCheckboxBtn = _vue2.default.extend(VueStrap.checkboxBtn);
var VCheckboxGroup = _vue2.default.extend(VueStrap.checkboxGroup);
var VDatepicker = _vue2.default.extend(VueStrap.datepicker);
var VOption = _vue2.default.extend(VueStrap.option);
var VPanel = _vue2.default.extend(VueStrap.panel);
var VProgressbar = _vue2.default.extend(VueStrap.progressbar);
var VRadioBtn = _vue2.default.extend(VueStrap.radioBtn);
var VRadioGroup = _vue2.default.extend(VueStrap.radioGroup);
var VSelect = _vue2.default.extend(VueStrap.select);
var VSlider = _vue2.default.extend(VueStrap.slider);
var VTab = _vue2.default.extend(VueStrap.tab);
var VTabset = _vue2.default.extend(VueStrap.tabset);
var VTypeahead = _vue2.default.extend(VueStrap.typeahead);
// Add Vue-Strap Components to Root Vue Instance
_vue2.default.component('v-accordion', VAccordion);
_vue2.default.component('v-affix', VAffix);
_vue2.default.component('v-alert', VAlert);
_vue2.default.component('v-aside', VAside);
_vue2.default.component('v-carousel', VCarousel);
_vue2.default.component('v-checkbox-btn', VCheckboxBtn);
_vue2.default.component('v-checkbox-group', VCheckboxGroup);
_vue2.default.component('v-datepicker', VDatepicker);
_vue2.default.component('v-option', VOption);
_vue2.default.component('v-panel', VPanel);
_vue2.default.component('v-progressbar', VProgressbar);
_vue2.default.component('v-radio-btn', VRadioBtn);
_vue2.default.component('v-radio-group', VRadioGroup);
_vue2.default.component('v-select', VSelect);
_vue2.default.component('v-slider', VSlider);
_vue2.default.component('v-tab', VTab);
_vue2.default.component('v-tabset', VTabset);
_vue2.default.component('v-typeahead', VTypeahead);

// Import App Components

// Add App Components to Root Vue Instance
_vue2.default.component('authenticate', _Authenticate2.default);
_vue2.default.component('feedback-button', _FeedbackButton2.default);
...
new _vue2.default({
    ...
    vuex: {
        getters: {
            authorized: _getters.getAuthorized
        },
        actions: {
            setAuthStatus: _actions.setAuthStatus
        }
    },
...
},{"./components/authentication/Authenticate.vue":34,"./components/buttons/FeedbackButton.vue":35,"./vuex/actions":36,"./vuex/getters":37,"./vuex/store":40,"vue":28,"vue-resource":16,"vue-strap/dist/vue-strap.min.js":27}],32:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        activateAppRegister: function activateAppRegister() {
            this.resetAppLoginForm();
            this.$dispatch('appRegisterWasClicked');
        },

        submitAppLoginForm: function submitAppLoginForm() {
            var self = this;
        ...
        resetAppLoginForm: function resetAppLoginForm() {
            formErrors.clear();
            var self = this;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/home/vagrant/CiFi/cifi/resources/assets/js/vue/components/authentication/AppLogin.vue"
  if (!module.hot.data) {
...
exports.default = {
    ...
    template: '#app-register-template',

    methods: {
        activateAppLogin: function activateAppLogin() {
            this.resetAppRegisterForm();
            this.$dispatch('appLoginWasClicked');
        },

        submitAppRegisterForm: function submitAppRegisterForm() {
            var self = this;
            var form = $('#user-register-form');
            var fields = self.appRegisterFields;
            var prefix = 'user-register-';

            this.$dispatch('authFormWasSubmitted', form, fields, prefix);
        },

        resetAppRegisterForm: function resetAppRegisterForm() {
            formErrors.clear();
            var self = this;
            self.appRegisterFields.token_key = appGlobals.csrf;
            self.appRegisterFields.name = null;
            self.appRegisterFields.email = null;
            self.appRegisterFields.password = null;
            self.appRegisterFields.password_confirmation = null;
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/vagrant/CiFi/cifi/resources/assets/js/vue/components/authentication/AppRegister.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
var _AppLogin = require('./AppLogin.vue');

var _AppLogin2 = _interopRequireDefault(_AppLogin);

var _AppRegister = require('./AppRegister.vue');

var _AppRegister2 = _interopRequireDefault(_AppRegister);
...
exports.default = {
    ...
    vuex: {
        actions: {
            setLoggedIn: _actions.setLoggedIn,
            setLoggedOut: _actions.setLoggedOut
        }
    },
    ...
    components: {
        'app-login': _AppLogin2.default,
        'app-register': _AppRegister2.default
    },

    events: {
        'appLoginWasClicked': function appLoginWasClicked() {
            var self = this;
            self.displayAppLogin();
        },
        'appRegisterWasClicked': function appRegisterWasClicked() {
            var self = this;
            self.displayAppRegister();
        },
        'authFormWasSubmitted': function authFormWasSubmitted(form, fields, prefix) {
            var self = this;
    ...
    methods: {
        displayAppLogin: function displayAppLogin() {
            var self = this;
        ...
        displayAppRegister: function displayAppRegister() {
            var self = this;
        ...
        processAuthForm: function processAuthForm(form, fields, prefix) {
            formErrors.clear();
            buttonFeedback.formSubmit(form, 'show');

            var self = this;
            this.$http.post(form.attr('action'), fields).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/vagrant/CiFi/cifi/resources/assets/js/vue/components/authentication/Authenticate.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../../vuex/actions":36,"./AppLogin.vue":32,"./AppRegister.vue":33,"vue":28,"vue-hot-reload-api":2}],35:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    props: [{ name: 'waitTxt', type: String, default: 'Waiting...' }, { name: 'btnType', type: String, default: 'submit' }, { name: 'btnClass', type: String, default: 'primary' }, { name: 'extClass', type: String, default: '' }],

    template: '<button type="{{btnType}}" class="btn btn-{{btnClass}}{{extClass}}">' + '<div class="btn-wait-content">' + '<span class="btn-wait-icon glyphicon glyphicon-hourglass animated rotateIn infinite"></span>&nbsp;' + '<span class="btn-wait-text animated flash infinite"></span>' + '</div><div class="orig-text" data-wait="{{waitTxt}}"><slot></slot></div></button>',
    ...
    methods: {
        showFeedback: function showFeedback() {
            ...
            self.$nextTick(function () {
                buttonFeedback.buttonClick($(this), 'hide');
            });
        }
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/vagrant/CiFi/cifi/resources/assets/js/vue/components/buttons/FeedbackButton.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
exports.setAuthStatus = exports.setLoggedOut = exports.setLoggedIn = undefined;
...
var setLoggedIn = exports.setLoggedIn = function setLoggedIn(_ref, jwt) {
...
var setLoggedOut = exports.setLoggedOut = function setLoggedOut(_ref2) {
...
var setAuthStatus = exports.setAuthStatus = function setAuthStatus(_ref3) {
    var dispatch = _ref3.dispatch;

    dispatch(types.SET_STATUS);
};

},{"./mutation-types":39}],37:[function(require,module,exports){
"use strict";
...
// Mutations
var mutations = (_mutations = {}, _defineProperty(_mutations, _mutationTypes.AUTHORIZE, function (state, jwt) {
    state.authorized = true;
    state.jwt = jwt;
}), _defineProperty(_mutations, _mutationTypes.DEAUTHORIZE, function (state) {
    state.authorized = false;
    state.jwt = null;
}), _defineProperty(_mutations, _mutationTypes.SET_STATUS, function (state) {
...
},{"../mutation-types":39}],39:[function(require,module,exports){
'use strict';
...
var DEAUTHORIZE = exports.DEAUTHORIZE = 'DEAUTHORIZE';
...
},{"./modules/auth":38,"_process":1,"vue":28,"vuex":29,"vuex/logger":30}]},{},[31]);
